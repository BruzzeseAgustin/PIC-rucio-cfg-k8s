...
kubectl create -f alertmanager/alertmanager-config.yaml
kubectl create -f alertmanager/alertmanager-deployment.yaml 
kubectl create -f alertmanager/alertmanager-service.yaml
kubectl create -f alertmanager/alertmanager-template.yaml
